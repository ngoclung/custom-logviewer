...
class CustomLogViewer extends LaravelLogViewer
{
    ...
    public static function pathToLogFile($file)
    {
        ...
        $file = ConfigureLogging::getLogFilePath($file);
        // check if requested file is really in the logs directory
        
        if (dirname($file) !== config('app.log_path')) {
    ...
    {
        $files = glob(ConfigureLogging::getLogFilePath('/*'));
